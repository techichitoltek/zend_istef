...
class App_View_Helper_EasterEgg extends Zend_View_Helper_Abstract {
    ...
    public function emoticon() {
        ...
        return sprintf($this->_linkTemplate, $this->_emoticons[$item]['url'], $this->_emoticons[$item]['label'], htmlentities($this->_emoticons[$item]['emoticon']));
    }
